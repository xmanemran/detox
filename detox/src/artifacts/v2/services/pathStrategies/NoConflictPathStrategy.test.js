...
describe(NoConflictPathStrategy, () => {
  ...
  it('should protect against relative ".." hacks', () => {
    ...
    expect(() => strategy.constructPathForTestArtifact(hackyTest, normalArtifact)).toThrowErrorMatchingSnapshot();
    expect(() => strategy.constructPathForTestArtifact(hackyTest, hackyArtifactName)).toThrowErrorMatchingSnapshot();
  });
