...
*/static rotateDeviceToOrientationErrorOrNil(element, deviceOrientation, errorOrNil) {
...
*/static dismissKeyboardWithError(element, errorOrNil) {
    ;
    return {
      target: {
        type: "Invocation",
